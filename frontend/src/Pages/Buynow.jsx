...
import { FaArrowLeftLong, FaCcMastercard, FaCcPaypal, FaCcVisa, FaArrowRightLong } from "react-icons/fa6";
...
const Buynow = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8081/singleProduct/${location.state.id}`)
            .then((res) => {
                setProduct(res.data)
            ...
            <div className='buynowcart'>
                <div className='containers'>
                    <div className='continueshopping'>
                        <FaArrowLeftLong className='arrowicon' /> <span>Continue Shopping</span>
                    </div>
                ...
                <div className='containers card'>
                    ...
                    <nav className='carddetails'>
                        ...
                        <div className='cardprofile'>
                            ...
                            <div>
                                <CgProfile className='cardprofileicon' />
                            </div>
                        </div>
